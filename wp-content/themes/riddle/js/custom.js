...
jQuery(document).ready(function($){
	...
	$('nav ul.menu > li.menu-item-has-children > a').on('click', function(e) {
			...
			$(this).parents('nav ul.menu > li.menu-item-has-children').toggleClass('open');
	...
	$('nav ul.menu > li.menu-item-has-children > ul.sub-menu > li.menu-item-has-children > a').on('click', function(e) {
			...
			$(this).parents('nav ul.menu > li.menu-item-has-children > ul.sub-menu > li.menu-item-has-children').toggleClass('open');
